"""
step08: Sequence + Scheduler（支持 block_table + prefix cache）

相比 step04 的变化：
  - Sequence 用 block_table 替代 past_key_values
  - Sequence 新增 prefill_offset（逐 Block 增量 prefill）
  - Scheduler 在请求完成时调用 block_manager.free() 归还 Block
"""
