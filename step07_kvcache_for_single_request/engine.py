"""
step07: NaiveEngine（对照）+ KVCacheEngine（本步核心）
...
_step01_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'step05_naive')
...
sys.path.pop(0)
# Clean up any 'model' cached by step05's exec so our local model.py is found
