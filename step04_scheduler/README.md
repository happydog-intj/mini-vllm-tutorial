...
GPU 显存中预分配一个大张量：
  ...
  kv_cache 形状: [4请求, 500槽位, 28层, 2(K和V), 8头, 64维]
  总大小: 4 × 500 × 28 × 2 × 8 × 64 × 2字节 = 1.8GB

  内存布局（每行代表一个请求的连续内存块）:
  ┌────────────────────────────────────────────────────────────────┐
  │ 请求0: [槽位0][槽位1][槽位2]...[槽位499]                        │ 900MB
  ├────────────────────────────────────────────────────────────────┤
  │ 请求1: [槽位0][槽位1][槽位2]...[槽位499]                        │ 900MB
  ├────────────────────────────────────────────────────────────────┤
  │ 请求2: [槽位0][槽位1][槽位2]...[槽位499]                        │ 900MB
  ├────────────────────────────────────────────────────────────────┤
  │ 请求3: [槽位0][槽位1][槽位2]...[槽位499]                        │ 900MB
  └────────────────────────────────────────────────────────────────┘
           ↑ 每个槽位存 28层的 K/V，共 2KB

  每个槽位展开（以第 i 个 token 为例）:
  ┌──────────────────────────────────────┐
  │ 第0层 K: [h0 h1 h2 h3 h4 h5 h6 h7]  │ ← 8个KV头，每头64维
  │ 第0层 V: [h0 h1 h2 h3 h4 h5 h6 h7]  │
  │ 第1层 K: [h0 h1 h2 h3 h4 h5 h6 h7]  │
  │ 第1层 V: [h0 h1 h2 h3 h4 h5 h6 h7]  │
  │ ...（共28层）                         │
  └──────────────────────────────────────┘
```
